...
cli_dl(c(name = "Definition of term"))
cli_end()
```
...
my_function <- function() {
  ...
  # No need to call cli_end() - auto-closes
}
```
...
cli_end(id = id)  # Close specific container
```
